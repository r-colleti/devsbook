            ...
            <div class="column pl-5">
                ...
                <div class="box">
                    <div class="box-header m-10">
                        <div class="box-header-text">
                            Astrofotos
                            <span>(<?=count($user->astrophotos);?>)</span>
                        </div>
                        <div class="box-header-buttons">
                            <a href="<?=$base;?>/perfil/<?=$user->id;?>/astrofotos">ver todos</a>
                        </div>
                    </div>
                    <div class="box-body-astro row m-20">

                        <?php for($q=0;$q<4;$q++): ?>
                            <?php if(isset($user->astrophotos[$q])): ?>
                                <div class="user-photo-item">
                                    <a href="<?= $base; ?>/astrofotografia/?id=<?= $user->astrophotos[$q]->id; ?>">
                                        <img src="<?=$base;?>/media/uploads/<?=$user->astrophotos[$q]->imagem;?>" />
                                    </a>
                                </div>
                            <?php endif; ?>
                        <?php endfor; ?>
